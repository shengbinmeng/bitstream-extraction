function ExtractSubstreamBasic(DIR, frame_num)
...
for k = 1:2:length(pri)
    ...
    tline = ['..\\bin\\BitStreamExtractorStatic ', DIR, '\\str\\Orig', int2str(frame_num), '.264 ', DIR, '\\str\\extract-basic\\', file_name, '.264 -r ', int2str(uint16((len_ql(k)/len_ql(1)*100))), '%%%% \r\n'];
    fprintf(fid, tline);
