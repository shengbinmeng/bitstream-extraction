function ExtractSubstreamQL(DIR)
...
for k = 1:length(pri)
    ...
    tline = ['..\\bin\\BitStreamExtractorStatic ', DIR, '\\str\\Foreman-ql.264 ', DIR, '\\str\\extract-ql\\', file_name, '.264 -e 352x288@30:', num2str(uint16((len(k)/41)*30*8/1000)), ' -ql\r\n'];
    fprintf(fid, tline);
